...
use aoc2021::{
    ...
    day20, day21, day22, day3, day4, day5, day6, day7, day8, day9, AocEntries,
};
...
fn main() -> Result<()> {
    ...
    match opt {
        ...
        AocEntries::Day20(args) => day20::day20(&args),
        AocEntries::Day21(args) => day21::day21(&args),
        AocEntries::Day22(args) => day22::day22(&args),
